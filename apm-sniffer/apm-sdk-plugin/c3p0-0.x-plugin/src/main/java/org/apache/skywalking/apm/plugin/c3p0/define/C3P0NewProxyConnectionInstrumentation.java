 ...
 * supports the jdbc4.
 * <p>
 * HikariCP use HikariProxyConnection which is the delegating implementation of Connection. All of the methods from the
 * Connection interface simply check to see that the Connection is active. In parent ProxyConnection#close()
...
public class C3P0NewProxyConnectionInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String INTERCEPTOR_CLASS = "org.apache.skywalking.apm.plugin.c3p0.PoolingCloseConnectInterceptor";
